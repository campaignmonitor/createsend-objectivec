...
typedef enum {
	/** No error. */
	CSSSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	CSSSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	CSSSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	CSSSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	CSSSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	CSSSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	CSSSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	CSSSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	CSSSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	CSSSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	CSSSKeychainErrorFailedToDecode = errSecDecode
} CSSSKeychainErrorCode;

extern NSString *const kCSSSKeychainErrorDomain;

/** Account name. */
extern NSString *const kCSSSKeychainAccountKey;
 ...
 */
extern NSString *const kCSSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kCSSSKeychainClassKey;

/** Item description. */
extern NSString *const kCSSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kCSSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kCSSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kCSSSKeychainWhereKey;
